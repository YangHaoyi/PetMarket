        ...
        new ActionSheetDialog(context)
                ...
                .addSheetItem("从手机相册选择", ActionSheetDialog.SheetItemColor.Red, new ActionSheetDialog.OnSheetItemClickListener() {
                    ...
                    public void onClick(int which) {
                        ...
                        System.out.println("qweqwewqeqweqweqw");
                    }
                })
                .show();
    }
...
//        intent.putExtra("camerasensortype", 2);// 调用前置摄像头
        ...
        context.startActivityForResult(intent, ImageController.PHOTO_REQUEST_TAKEPHOTO_TRUE);
    }
    /***
     * 调用系统的图库
     * @param context Activity上下文对象
    ...
    private static void startImageCaptrue(Activity context) {
        ...
        context.startActivityForResult(intent, ImageController.PHOTO_REQUEST_GALLERY_TRUE);
    }
